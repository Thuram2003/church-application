  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        {showCloseButton && (
          <SheetPrimitive.Close className="absolute top-5 right-5 rounded-full p-2 opacity-80 transition-all hover:bg-[#F3F4F6] hover:opacity-100 focus:outline-none disabled:pointer-events-none">
            <X className="size-6 text-[#1E293B]" />
